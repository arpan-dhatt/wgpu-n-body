...
struct Quadrant {
    px: f32; py: f32; pz: f32;
    mass: f32;
    fxy: u32; fnxy: u32; fnxny: u32; fxny: u32;
    bxy: u32; bnxy: u32; bnxny: u32; bxny: u32;
};
...
struct Quadrants {
    particles: [[stride(48)]] array<Quadrant>;
};

[[group(0), binding(0)]] var<uniform> params: SimParams;
[[group(0), binding(1)]] var<storage, read> particlesSrc: Particles;
[[group(0), binding(2)]] var<storage, read> treeSrc: Quadrants;
[[group(0), binding(3)]] var<storage, read_write> particlesDst: Particles;
